...
WHERE r.name = 'ADMIN' and p.name='READ' 
ON CONFLICT (role_id, permission_id) DO NOTHING;

INSERT INTO role_permissions (role_id, permission_id)
SELECT r.id, p.id FROM app_role r, Permission p 
WHERE r.name = 'ADMIN' and p.name='WRITE' 
ON CONFLICT (role_id, permission_id) DO NOTHING;

INSERT INTO app_user (username, password, email) 
VALUES ('admin', '$2a$10$oVfiGKiG06IvuKmFIMrwXeZEO4S24/ZE0yf8nDDlmYcmhN/wUaEeq', 'admin@example.com') 
